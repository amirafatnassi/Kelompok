@extends('layouts.doctor', ['title' => 'Modifier Patient'])

@section('content')
<div class="container py-5">
    <h2 class="mb-4">Modifier le patient</h2>
        ...
        <div class="card">
            <div class="row">
                ...
                <div class="mb-3 col-md-4">
                    ...
                    <input type="date" name="date_of_birth" id="date_of_birth" class="form-control" value="{{ old('date_of_birth', $patient->date_of_birth->format('Y-m-d')) }}">
                </div>
                ...
                <div class="mb-3 col-12">
                    ...
                    <input name="address_line1" id="address_line1" class="form-control" rows="3" value="{{ old('address_line1', $patient->address_line1) }}" />
                </div>

                <div class="mb-3 col-12">
                    <label for="address_line2" class="form-label">Adresse 2</label>
                    <input name="address_line2" id="address_line2" class="form-control" rows="3" value="{{ old('address_line2', $patient->address_line2) }}" />
                </div>
            </div>
