                        ...
                        <div class="row">
                            ...
                            <div class="col-4">
                                <input type="text" name="medical_record_number" id="medical_record_number" class="form-control"
                                    placeholder="Medical Record Number" title="Medical Record Number">
                            </div>

                            <div class="col-3">
                                <input type="date" name="date_of_birth" id="date_of_birth" class="form-control"
                                    placeholder="🗓️ Date of Birth" title="Date of birth">
                            </div>

                            <div class="col-lg-6 col-12">
                                <input type="email" name="Email" id="Email" pattern="[^ @]*@[^ @]*"
                                    class="form-control" placeholder="Email address" title="Email address" required='true'>
                            </div>

                            <div class="col-lg-3 col-12">
                                <input type="telephone" name="MobileNumber" id="MobileNumber" class="form-control"
                                    placeholder="Enter Phone Number" title="Phone Number" maxlength="10">
                            </div>
                            <hr>
                            <p>Appointment</p>
                            <div class="col-lg-6 col-12">
                                <input type="date" name="AppointmentDate" id="AppointmentDate" value=""
                                    class="form-control" title="Appointment Date" >
                            </div>

                            <div class="col-lg-6 col-12">
                                <input type="time" name="AppointmentTime" id="AppointmentTime" value=""
                                    class="form-control" title="Appointment Time">
                            </div>
